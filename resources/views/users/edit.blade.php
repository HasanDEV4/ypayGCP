...
<div class="container-fluid content-header">
  ...
  {{-- Basic --}}
  <form {{-- action="{{ route('fund.save') }}" --}} {{-- method="POST" --}} id="editUserForm" enctype="multipart/form-data">
    <div class="col-lg-12">
        ...
        <div class="card-body">
          <div class="row mb-3">
            ...
            <div class="col-12 col-md-3">
              ...
              <input type="email" class="form-control email" id="email" placeholder="Enter Email" name="email" autocomplete="off" value="{{ $user->email }}">
              <div class="invalid-feedback error hide">
              </div>
            </div>
            {{-- <div class="col-12 col-md-3">
              ...
              <input type="text" class="form-control password" id="password" placeholder="Enter Password" name="password" autocomplete="off" value="{{ old('password') }}">
              <div class="invalid-feedback error hide">
              </div>
            </div> --}}
            <div class="col-12 col-md-3">
              ...
              <div class="col-12 col-md-3">
                ...
                <select class="mb-2 form-control" name="role" autocomplete="off">
                    <option selected disabled>Select Status</option>
...
<script>
  $( document ).ready(function() {
    ...
    var id = $('#editUserForm').find($('input[name="id"]')).val();
