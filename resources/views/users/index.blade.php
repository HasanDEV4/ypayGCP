                    ...
                    //   },
                      ...
                      },
                      {
                          ...
                          render: function (data, type, row) {
                              if(data == null) {
                                ...
                                return `<div class="badge badge-success p-2">${data}</div>`;
                              }
                          },
                      },
                      {
                      ...
                      
                      {
                          ...
                          render: function (data, type, row) {
                            return `<div class="btn-group dropdown" role="group">
                                @can('edit-user')
                                <a class="btn btn-sm btn-light text-center " type="button" href="{{ url('/') }}/user/${row.id}/edit"><i class="fas fa-edit text-info fa-lg"></i></a>
                                @endcan
                                  </div>`;
                          },
                          searchable: false,
