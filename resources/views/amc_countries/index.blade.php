  ...
  <div class="row">
    <div class="col-12 d-flex flex-column flex-md-row justify-content-between w-100  align-items-start align-items-md-center">
      <div class="ml-2 pl-1">
          ...
          <p>
              <a>AMC Management</a> /
              <span>AMC Countries</span>
          </p>
      </div>
      <a  class="btn btn-primary" id='getcountriesbtn'>
        <i class="fa fa-refresh mr-2"></i>
        Refresh AMC's Countries Data
      </a>
    </div>
  </div>
              ...
              <div class="card-body">
                  <table class="mb-0 table datatable">
                      <thead>
                          <tr>
                              <th>AMC</th>
                              <th>AMC Country ID</th>
                              <th>AMC Country Name</th>
                              <th>YPay Country ID</th>
                              <th>YPay Country Name</th>
                              <th>Created At</th>
                          </tr>
                      </thead>
                      <tbody>
...
@push('scripts')
  <script>
    ...
    $(function () {
        ...
        getamccountries(amc,csvtype,uploadstatus);
        });
        ...
        $('#getcountriesbtn').click(function (e) {
            e.preventDefault();
            $.ajax({
              data: '',
              url: "{{ route('amc_countries.refresh') }}",
              type: "GET",
              dataType:'JSON',
              contentType: false,
              cache: false,
        ...
        var table;
        function getamccountries(amc='')
        {
        
        var queryParams = '?&amc='+amc;
        console.log('queryParams',queryParams)
          var url = "{{route('amc_countries.getData')}}";
