...
<div class="container-fluid content-header">
  ...
  {{-- Basic --}}
  <form {{-- action="{{ route('fund.save') }}" --}} {{-- method="POST" --}} id="editRoleForm" enctype="multipart/form-data">
    <div class="col-lg-12">
      <div class="d-flex flex-row justify-content-between mb-2">
        <h4 class="font-weight-bold mb-0">Edit Role</h4>
      </div>
      @if (count($errors) > 0)
      ...
      <div class="main-card mb-3 card">
        <div class="card-body">
          <div class="row mb-3">
            <div class="col-md-12">
              ...
              <input type="text" class="form-control name" id="name" placeholder="Enter Role Name" name="name" autocomplete="off" value="{{ $role->name }}">
        ...
        <div class="row mb-3">
            <div class="main-card mb-3 card">
                <div class="card-body">
                  <table class="mb-0 table table-bordered datatable" style="width: 100%">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><input type="checkbox" name="permission[]" value="{{ $permission->id}}" @if( in_array($permission->id, $rolePermissions) ) checked="1" @endif></td>
...
<script>
  $( document ).ready(function() {
    ...
    var id = $('#editRoleForm').find($('input[name="id"]')).val();
