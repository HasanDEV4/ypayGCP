...
class FundController2 extends Controller
{
    ...
    public function amcShow(Request $request, $id)
    {
        ...
        $fund = Fund::with(['additional_details' => function($q){
            ...
            $q->where('id', $id);
        })->select('id','user_id','amc_id','fund_name','risk_profile','fund_size','nav','fund_image','return_rate')->get();
    ...
    public function show($id)
    {
        ...
        // $data['is_profile_risk']=$data['risk_profile'];
    ...
    public function get_popular_and_new(Request $request)
    {
        $popularfunds = Fund::with(['additional_details' => function($q){
            ...
            $q->where('status', 1);
        })->select('id','user_id','amc_id','fund_name','fund_size','nav','fund_image','return_rate')->get();
        ...
        foreach($popularfundsrecord as $key => $value){
                ...
                // $popularfundsrecord[$key]['is_profile_risk']=$value['risk_profile'];
        ...
        foreach($newfundsrecord as $key => $value){
            ...
            // $newfundsrecord[$key]['is_profile_risk']=$value['risk_profile'];
            $new_funds_data=$newfundsrecord;
    }
